...
/*! @name FC1_CTS_SDA_SSEL0 (coord J3), SW2
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_SDA_PERIPHERAL FLEXCOMM1       /*!<@brief Peripheral name */
#define BOARD_INITPINS_SDA_SIGNAL CTS_SDA_SSEL0       /*!<@brief Signal name */
                                                      /* @} */

/*! @name FC1_RTS_SCL_SSEL1 (coord L1), J31[13]/I2C_SCL
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_SCL_PERIPHERAL FLEXCOMM1               /*!<@brief Peripheral name */
#define BOARD_INITPINS_SCL_SIGNAL RTS_SCL_SSEL1               /*!<@brief Signal name */
                                                              /* @} */
