...
/*! @name PIO0_14 (coord A3), Q4[5]
  @{ */
/* Routed pin properties */
#define BOARD_INITDEBUGCONSOLEPINS_LED_GREEN_PERIPHERAL GPIO           /*!<@brief Peripheral name */
#define BOARD_INITDEBUGCONSOLEPINS_LED_GREEN_SIGNAL PIO0               /*!<@brief Signal name */
#define BOARD_INITDEBUGCONSOLEPINS_LED_GREEN_CHANNEL 14                /*!<@brief Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITDEBUGCONSOLEPINS_LED_GREEN_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITDEBUGCONSOLEPINS_LED_GREEN_GPIO_PIN_MASK (1U << 14U) /*!<@brief GPIO pin mask */
#define BOARD_INITDEBUGCONSOLEPINS_LED_GREEN_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITDEBUGCONSOLEPINS_LED_GREEN_PIN 14U                   /*!<@brief PORT pin number */
#define BOARD_INITDEBUGCONSOLEPINS_LED_GREEN_PIN_MASK (1U << 14U)      /*!<@brief PORT pin mask */
                                                                       /* @} */
