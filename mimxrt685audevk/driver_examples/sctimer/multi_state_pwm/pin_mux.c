...
- pin_list:
  ...
  - {pin_num: F4, peripheral: SCT0, signal: 'OUT, 0', pin_signal: PIO0_5/FC0_SSEL2/SCT0_GPI0/SCT0_OUT0/CTIMER_INP1/SEC_PIO0_5/ADC0_0}
  - {pin_num: G15, peripheral: SCT0, signal: 'IN, 1', pin_signal: PIO1_1/FC4_SSEL2/SCT0_GPI2/SCT0_OUT8/CTIMER1_MAT0, ibena: enabled}
  - {pin_num: E1, peripheral: SCT0, signal: 'OUT, 1', pin_signal: PIO0_6/FC0_SSEL3/SCT0_GPI1/SCT0_OUT1/CTIMER0_MAT0/SEC_PIO0_6/ADC0_8}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin5_config = (/* Pin is configured as SCT0_OUT0 */
                                        ...
                                        /* Input function is not inverted */
                                        IOPCTL_PIO_INV_DI);
    /* PORT0 PIN5 (coords: F4) is configured as SCT0_OUT0 */
    ...
    const uint32_t port0_pin6_config = (/* Pin is configured as SCT0_OUT1 */
                                        ...
                                        /* Input function is not inverted */
                                        IOPCTL_PIO_INV_DI);
    /* PORT0 PIN6 (coords: E1) is configured as SCT0_OUT1 */
