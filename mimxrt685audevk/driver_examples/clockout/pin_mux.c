...
- pin_list:
  ...
  - {pin_num: N17, peripheral: SYSCON, signal: CLKOUT, pin_signal: PIO2_29/I3C0_SCL/SCT0_OUT0/CLKOUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port2_pin29_config = (/* Pin is configured as CLKOUT */
                                         IOPCTL_PIO_FUNC5 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT2 PIN29 (coords: N17) is configured as CLKOUT */
