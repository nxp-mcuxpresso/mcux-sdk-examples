...
cs42448_config_t g_cs42448Config = {
    ...
    .format       = {.sampleRate = 96000U, .bitWidth = 24U},
    .bus          = kCS42448_BusI2S,
...
int BOARD_CodecChangeSettings(uint8_t nchannel)
{
    ...
    {
        case 2:
            return CS42448_SetProtocol(devHandle, kCS42448_BusI2S, g_cs42448Config.format.bitWidth);
        case 8:
            /* Intentional fall */
        default:
            return CS42448_SetProtocol(devHandle, kCS42448_BusTDM, g_cs42448Config.format.bitWidth);
    }
}
