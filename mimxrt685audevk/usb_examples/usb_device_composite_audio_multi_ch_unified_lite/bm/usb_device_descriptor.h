 ...
 * Definitions
 ******************************************************************************/
#define USB_AUDIO_MULTI_CHANNEL_PLAY_SEL (1U) /* 1: the pre 8 channels, 2: the last 8 channels, total channel is 16U */
...
#define USB_COMPOSITE_INTERFACE_COUNT (3)
...
/* Audio data format */
#define AUDIO_OUT_FORMAT_CHANNELS (0x10U)
#define AUDIO_OUT_FORMAT_BITS     (16)
#define AUDIO_OUT_FORMAT_SIZE     (0x02)
#define AUDIO_IN_FORMAT_CHANNELS  (0x10U)
