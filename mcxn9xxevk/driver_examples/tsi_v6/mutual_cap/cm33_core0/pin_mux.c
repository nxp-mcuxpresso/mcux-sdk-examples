...
- pin_list:
  ...
  - {pin_num: D16, peripheral: GPIO3, signal: 'GPIO, 3', pin_signal: PIO3_3/FC7_P1/CT4_MAT1/PWM0_X1/FLEXIO0_D11/SIM1_RST, direction: OUTPUT, eft_interrupt: disable,
    slew_rate: fast, open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, input_buffer: enable, invert_input: normal}
  - {pin_num: C6, peripheral: TSI0, signal: 'CH, 0', pin_signal: PIO1_0/WUU0_IN6/LPTMR0_ALT3/TRIG_IN0/FC3_P0/FC4_P4/CT_INP4/SCT0_OUT6/FLEXIO0_D8/SAI1_TX_BCLK/TSI0_CH0/ADC0_A16/CMP0_IN0,
  ...
  - {pin_num: C9, peripheral: TSI0, signal: 'CH, 14', pin_signal: PIO0_19/WUU0_IN3/EWM0_OUT_b/FC0_P3/CT0_MAT3/FLEXIO0_D3/HSCMP1_OUT/TSI0_CH14/ADC0_A11, slew_rate: fast,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port0_19_pinC9_config = {/* Internal pull-up/down resistor is disabled */
                                                     kPORT_PullDisable,
                                                     ...
                                                     /* Pin is configured as TSI0_CH14 */
                                                     kPORT_MuxAlt0,
    ...
    /* PORT0_19 (pin C9) is configured as TSI0_CH14 */
    PORT_SetPinConfig(PORT0, 19U, &port0_19_pinC9_config);
    ...
    const port_pin_config_t port1_0_pinC6_config = {/* Internal pull-up/down resistor is disabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORT1_0 (pin C6) is configured as TSI0_CH0 */
