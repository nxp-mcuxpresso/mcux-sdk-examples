...
- pin_list:
  ...
  - {pin_num: C8, peripheral: GPIO0, signal: 'GPIO, 20', pin_signal: PIO0_20/WUU0_IN4/FC0_P4/FC1_P0/CT_INP0/FLEXIO0_D4/I3C0_SDA/ADC0_A12, direction: INPUT, slew_rate: fast,
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t gpio0_pinC8_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_20 (pin C8)  */
    GPIO_PinInit(GPIO0, 20U, &gpio0_pinC8_config);
