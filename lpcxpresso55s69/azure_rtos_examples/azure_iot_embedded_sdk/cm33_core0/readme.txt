...
9. Write the above device parameters into the source code, sample_config.h, in your project. Fill these three macros,
   ...
   For example:
     ...
     #define DEVICE_SYMMETRIC_KEY "1r6MyMakh5jGqllVPkXsJXkHedzBjx9ri8H5u7uOSZ0="
...
Prepare the Demo
================
1.  Connect the USB A Female to Micro B Male cable between the USB RJ45 adapter and
