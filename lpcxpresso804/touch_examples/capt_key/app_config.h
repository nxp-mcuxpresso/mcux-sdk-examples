 ...
 * Touch Configuration
 ******************************************************************************/
#define TOUCH_X_CHANNEL_COUNT 5
 ...
 */
#define TOUCH_PRESSED_KEY_COUNT_DECREASE 0

/*******************************************************************************
 * Touch HAL Configuration
 ******************************************************************************/
#define TOUCH_HAL_CAPT             CAPT
#define TOUCH_HAL_CAPT_ENABLE_PINS (kCAPT_X0Pin | kCAPT_X1Pin | kCAPT_X2Pin | kCAPT_X3Pin | kCAPT_X4Pin)
