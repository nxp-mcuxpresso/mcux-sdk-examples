...
- pin_list:
  ...
  - {pin_num: '15', peripheral: ACMP, signal: ACMP_IN2, pin_signal: PIO0_1/ADC_0/ACMP_I2/CLKIN, mode: inactive, invert: disabled, hysteresis: enabled, opendrain: enabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t IOCON_INDEX_PIO0_1_config = (/* No addition pin function */
                                                ...
                                                IOCON_PIO_OD_EN);
    /* PIO0 PIN1 (coords: 15) is configured as ACMP, ACMP_IN2. */
