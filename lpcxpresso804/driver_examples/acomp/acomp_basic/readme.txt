...
## Board Settings
------------------------
CAN5 pin6 is ACOMP negative input pin, which can sample external voltage.
...
## Expected Result
------------------------
If the ACOMP input CAN5 pin6 connects the GND, LED(D2) will be turned on.
If the ACOMP input CAN5 pin6 connects the 3.3V, LED(D2) will be turned off.
