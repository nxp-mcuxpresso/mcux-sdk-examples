...
- pin_list:
  ...
  - {pin_num: '1', peripheral: USART1, signal: RXD, pin_signal: PIO0_18}
  - {pin_num: '13', peripheral: USART1, signal: TXD, pin_signal: PIO0_20}
  - {pin_num: '24', peripheral: USART1, signal: SCLK, pin_signal: PIO0_19/DACOUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* USART1_SCLK connect to P0_19 */
    SWM_SetMovablePinSelect(SWM0, kSWM_USART1_SCLK, kSWM_PortPin_P0_19);
