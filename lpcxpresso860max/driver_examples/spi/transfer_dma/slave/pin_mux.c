...
- pin_list:
  ...
  - {pin_num: '36', peripheral: USART0, signal: RXD, pin_signal: PIO1_16, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
  - {pin_num: '28', peripheral: SPI0, signal: MISO, pin_signal: PIO0_24, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t IOCON_INDEX_PIO1_9_config = (/* Selects pull-up function */
    ...
    const uint32_t IOCON_INDEX_PIO1_8_config = (/* Selects pull-up function */
                                                 IOCON_PIO_MODE_PULLUP |
                                                 /* Enable hysteresis */
                                                 IOCON_PIO_HYS_EN |
                                                 /* Input not invert */
    ...
    /* SPI0_SCK connect to P1_9 */
    SWM_SetMovablePinSelect(SWM0, kSWM_SPI0_SCK, kSWM_PortPin_P1_9);

    /* SPI0_MOSI connect to P0_17 15*/
    SWM_SetMovablePinSelect(SWM0, kSWM_SPI0_MOSI, kSWM_PortPin_P0_17);

    /* SPI0_MISO connect to P1_8 */
    SWM_SetMovablePinSelect(SWM0, kSWM_SPI0_MISO, kSWM_PortPin_P1_8);

    /* SPI0_SSEL0 connect to P0_18 */
    SWM_SetMovablePinSelect(SWM0, kSWM_SPI0_SSEL0, kSWM_PortPin_P0_18);
