...
pin_labels:
- {pin_num: '4', pin_signal: PIO0_12, label: LED_RED, identifier: LED_RED}
...
- pin_list:
  - {pin_num: '4', peripheral: GPIO, signal: 'PIO0, 12', pin_signal: PIO0_12, direction: OUTPUT, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled,
