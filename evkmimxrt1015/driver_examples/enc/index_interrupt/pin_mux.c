...
- pin_list:
  - {pin_num: '4', peripheral: ENC1, signal: 'PHASE, A', pin_signal: GPIO_EMC_06, slew_rate: Slow, software_input_on: Enable, open_drain: Disable, speed: MHZ_100,
  ...
  - {pin_num: '3', peripheral: ENC1, signal: 'PHASE, B', pin_signal: GPIO_EMC_07, slew_rate: Slow, software_input_on: Enable, open_drain: Disable, speed: MHZ_100,
    drive_strength: R0_6, pull_keeper_select: Keeper, pull_keeper_enable: Enable, pull_up_down_config: Pull_Down_100K_Ohm, hysteresis_enable: Disable}
  - {pin_num: '22', peripheral: ENC1, signal: INDEX, pin_signal: GPIO_SD_B1_00, slew_rate: Slow, software_input_on: Enable, open_drain: Disable, speed: MHZ_100, drive_strength: R0_6,
