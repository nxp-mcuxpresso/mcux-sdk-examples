...
- pin_list:
  ...
  - {pin_num: '1', peripheral: GPIO2, signal: 'gpio_io, 09', pin_signal: GPIO_EMC_09, software_input_on: Disable, open_drain: Disable, drive_strength: R0_4, pull_keeper_select: Pull,
