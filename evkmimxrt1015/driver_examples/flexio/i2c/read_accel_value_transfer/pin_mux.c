...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_20_FLEXIO1_FLEXIO24, 1U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_26_FLEXIO1_FLEXIO30, 1U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_06_LPUART1_TX, 0x10B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_07_LPUART1_RX, 0x10B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_EMC_20_FLEXIO1_FLEXIO24, 0xF8B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_EMC_26_FLEXIO1_FLEXIO30, 0xF8B0U); 
}
