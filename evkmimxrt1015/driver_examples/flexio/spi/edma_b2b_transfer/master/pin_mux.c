...
- pin_list:
  - {pin_num: '52', peripheral: FLEXIO1, signal: 'IO, 00', pin_signal: GPIO_AD_B1_15, direction: INPUT, slew_rate: Fast, software_input_on: Enable}
  - {pin_num: '53', peripheral: FLEXIO1, signal: 'IO, 01', pin_signal: GPIO_AD_B1_14, direction: OUTPUT, slew_rate: Fast}
  - {pin_num: '54', peripheral: FLEXIO1, signal: 'IO, 02', pin_signal: GPIO_AD_B1_13, direction: OUTPUT, slew_rate: Fast}
  - {pin_num: '55', peripheral: FLEXIO1, signal: 'IO, 03', pin_signal: GPIO_AD_B1_12, direction: OUTPUT, slew_rate: Fast}
