...
PRIMARY_SERVICE(service_hid, 0x1812)
    ...
    CHARACTERISTIC(char_boot_mouse_input_report, gBleSig_HidBootMouseInputReport_d, (gGattCharPropRead_c | gGattCharPropNotify_c | gGattCharPropWrite_c) )
        VALUE_VARLEN(value_boot_mouse_input_report, gBleSig_HidBootMouseInputReport_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 3, 3, 0x00, 0x00, 0x00)
