...
#define RTE_SPI3_DMA_TX_PERI_SEL        kDma4RequestMuxLPSPI3Tx
#define RTE_SPI3_DMA_TX_DMA_BASE        DMA4
#define RTE_SPI3_DMA_RX_CH              1
#define RTE_SPI3_DMA_RX_PERI_SEL        kDma4RequestMuxLPSPI3Rx
#define RTE_SPI3_DMA_RX_DMA_BASE        DMA4
#endif /* _RTE_DEVICE_H */
