...
#define TIMER_CHANNEL_0_CLOCK_SOURCE 8250000UL
/* TIMER interrupt vector ID (number). */
#define TIMER_IRQN TMR5_IRQn
/* TIMER interrupt handler identifier. */
#define TIMER_IRQ_HANDLER TMR5_IRQHandler
/* BOARD_InitPeripherals defines for LPI2C2 */
/* Definition of peripheral ID */
#define ACCEL_I2C_PERIPHERAL LPI2C2
