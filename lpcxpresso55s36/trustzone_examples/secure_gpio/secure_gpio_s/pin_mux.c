...
- pin_list:
  ...
  - {pin_num: '95', peripheral: FLEXCOMM0, signal: TXD_SCL_MISO_WS, pin_signal: PIO0_30/FC0_TXD_SCL_MISO_WS/CTIMER0_MAT0/SCT0_OUT9/TRACEDATA1/CAN0_TD/FC6_TXD_SCL_MISO_WS/SECURE_GPIO0_30/PWM1_A1/AOI1_OUT0,
    mode: inactive, slew_rate: standard, invert: disabled, open_drain: disabled}
  - {pin_num: '41', peripheral: SECGPIO, signal: 'SECPIO0, 17', pin_signal: PIO0_17/FC4_SSEL2/SCT_GPI7/SCT0_OUT0/FC5_RXD_SDA_MOSI_DATA/QSPI_SCLK/SECURE_GPIO0_17/TRIGOUT_7/HSCMP1_OUT/HSCMP2_IN0,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin17_config = (/* Pin is configured as SECURE_GPIO0_17 */
                                         IOCON_PIO_FUNC10 |
                                         ...
                                         IOCON_PIO_ASW0_DI);
    /* PORT0 PIN17 (coords: 41) is configured as SECURE_GPIO0_17 */
