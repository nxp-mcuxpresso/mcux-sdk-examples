...
- pin_list:
  - {pin_num: '25', peripheral: ADC0, signal: 'CH, 0A', pin_signal: PIO1_9/FC1_SCK/CT_INP4/SCT0_OUT2/FC4_CTS_SDA_SSEL0/AOI1_OUT3/ADC0_0A/OPAMP0_OUT/HSCMP0_IN4, mode: inactive,
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t gpio1_pin25_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_9 (pin 25)  */
    GPIO_PinInit(GPIO, 1U, 9U, &gpio1_pin25_config);
    ...
    const uint32_t port1_pin9_config = (/* Pin is configured as ADC0_0A */
                                        IOCON_PIO_FUNC0 |
                                        /* No addition pin function */
                                        IOCON_PIO_MODE_INACT |
                                        /* Standard mode, output slew rate control is enabled */
                                        ...
                                        IOCON_PIO_ASW0_EN);
    /* PORT1 PIN9 (coords: 25) is configured as ADC0_0A */
