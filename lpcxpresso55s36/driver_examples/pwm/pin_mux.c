...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin3_config = (/* Pin is configured as PWM1_B0 */
                                        IOCON_PIO_FUNC11 |
                                        /* No addition pin function */
                                        IOCON_PIO_MODE_INACT |
                                        /* Standard mode, output slew rate control is enabled */
                                        ...
                                        /* Open drain is disabled */
                                        IOCON_PIO_OPENDRAIN_DI);
    /* PORT0 PIN3 (coords: 84) is configured as PWM1_B0 */
    ...
    const uint32_t port1_pin21_config = (/* Pin is configured as PWM1_A0 */
                                         IOCON_PIO_FUNC11 |
                                         /* No addition pin function */
                                         IOCON_PIO_MODE_INACT |
                                         /* Standard mode, output slew rate control is enabled */
    ...
    const uint32_t port1_pin23_config = (/* Pin is configured as PWM1_A1 */
                                         IOCON_PIO_FUNC11 |
                                         /* No addition pin function */
                                         IOCON_PIO_MODE_INACT |
                                         /* Standard mode, output slew rate control is enabled */
                                         ...
                                         IOCON_PIO_ASW0_DI);
    /* PORT1 PIN23 (coords: 49) is configured as PWM1_A1 */
    IOCON_PinMuxSet(IOCON, 1U, 23U, port1_pin23_config);

    const uint32_t port1_pin25_config = (/* Pin is configured as PWM1_A2 */
                                         IOCON_PIO_FUNC11 |
                                         /* No addition pin function */
                                         IOCON_PIO_MODE_INACT |
                                         /* Standard mode, output slew rate control is enabled */
                                         ...
                                         /* Open drain is disabled */
                                         IOCON_PIO_OPENDRAIN_DI);
    /* PORT1 PIN25 (coords: 77) is configured as PWM1_A2 */
