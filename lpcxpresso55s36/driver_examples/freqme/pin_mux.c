...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin11_config = (/* Pin is configured as FREQME_GPIO_CLK_A */
                                         IOCON_PIO_FUNC3 |
    ...
    /* PORT0 PIN11 (coords: 9) is configured as FREQME_GPIO_CLK_A */
    IOCON_PinMuxSet(IOCON, 0U, 11U, port0_pin11_config);

    const uint32_t port0_pin12_config = (/* Pin is configured as FREQME_GPIO_CLK_B */
                                         IOCON_PIO_FUNC3 |
                                         /* Selects pull-down function */
                                         IOCON_PIO_MODE_PULLDOWN |
                                         /* Fast mode, slew rate control is disabled */
                                         ...
                                         /* Open drain is disabled */
                                         IOCON_PIO_OPENDRAIN_DI);
    /* PORT0 PIN12 (coords: 10) is configured as FREQME_GPIO_CLK_B */
