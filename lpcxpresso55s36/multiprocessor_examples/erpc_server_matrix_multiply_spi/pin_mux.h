...
/*! @name PIO0_13 (number 70), J10[3]/U27[1]/P0_13-FC1_SDA-SCT0_GPI0-EXTTRIG_IN3
  @{ */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_GPIO_BRIDGE_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_GPIO_BRIDGE_GPIO_PIN_MASK (1U << 13U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_GPIO_BRIDGE_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_GPIO_BRIDGE_PIN 13U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_GPIO_BRIDGE_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                                             /* @} */

/*! @name HS_SPI_SSEL1 (number 59), P1_1-HS_SPI_SSEL1-TRACECLK
  @{ */
/* @} */
