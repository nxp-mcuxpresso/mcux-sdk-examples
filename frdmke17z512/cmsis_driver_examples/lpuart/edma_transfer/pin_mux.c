...
- options: {callFromInitBoot: 'false', coreID: cm0plus, enableClock: 'true'}
- pin_list:
  - {pin_num: '19', peripheral: n/a, signal: disabled, pin_signal: PTE12/FTM0_FLT3/LPUART2_TX/TRGMUX_OUT3}
  - {pin_num: '20', peripheral: n/a, signal: disabled, pin_signal: PTD17/FTM0_FLT2/LPUART2_RX/TRGMUX_OUT2}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
