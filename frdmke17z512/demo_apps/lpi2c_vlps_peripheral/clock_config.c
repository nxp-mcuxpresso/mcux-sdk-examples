...
- {id: SCG.FIRCDIV2.scale, value: '0', locked: true}
...
const scg_firc_config_t g_scgFircConfig_BOARD_BootClockRUN =
    {
        .enableMode = kSCG_FircEnable | kSCG_FircEnableInStop,/* Enable FIRC clock, Enable FIRC in stop mode */
