...
- pin_list:
  ...
  - {pin_num: '17', peripheral: GPIOE, signal: 'GPIO, 14', pin_signal: PTE14/FTM0_FLT1/TRGMUX_OUT4, drive_strength: low, pull_select: up, pull_enable: enable, passive_filter: disable,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t porte14_pin17_config = {/* Internal pull-up resistor is enabled */
                                                    kPORT_PullUp,
                                                    /* Passive filter is disabled */
                                                    kPORT_PassiveFilterDisable,
                                                    /* Low drive strength is configured */
                                                    kPORT_LowDriveStrength,
                                                    /* Pin is configured as PTE14 */
                                                    kPORT_MuxAsGpio,
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORTE14 (pin 17) is configured as PTE14 */
    PORT_SetPinConfig(PORTE, 14U, &porte14_pin17_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
