...
- pin_list:
  - {pin_num: N6, peripheral: CTIMER2, signal: 'MATCH, 0', pin_signal: PIO0_17}
  ...
  - {pin_num: M7, peripheral: CTIMER2, signal: 'MATCH, 1', pin_signal: PIO0_18}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin17_config = (/* Pin is configured as CTIMER2_MATCH0 */
                                         IOPCTL_PIO_FUNC4 |
    ...
    /* PORT0 PIN17 (coords: N6) is configured as CTIMER2_MATCH0 */
    IOPCTL_PinMuxSet(0U, 17U, port0_pin17_config);

    const uint32_t port0_pin18_config = (/* Pin is configured as CTIMER2_MATCH1 */
                                         IOPCTL_PIO_FUNC4 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Selects transmitter current drive 100ohm */
                                         IOPCTL_PIO_DRIVE_100OHM);
    /* PORT0 PIN18 (coords: M7) is configured as CTIMER2_MATCH1 */
