...
#define IOPCTL_PIO_FUNC0 0x00U /*!<@brief MUX as sdadc channel 0 input */
#define IIENA_DISABLE 0x00U /*!<@brief Disable the input invert. */
#define ODENA_DISABLE 0x00U /*!<@brief Disable the open drain. */
#define AMENA_ENABLE 0x200U /*!<@brief Enable the analog mux. */
#define FULLDRIVE_NORMAL 0x00U /*!<@brief Normal drive. */
#define SLEW_STANDARD 0x00U /*!<@brief Standard slew mode. */
#define IBENA_DISABLE 0x00U /*!<@brief Disable the input buffer. */

/* Internal pull-up/down resistor is disabled. */
#define PUPDENA_DISABLE 0x00U
