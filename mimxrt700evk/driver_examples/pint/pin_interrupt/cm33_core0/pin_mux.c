...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port1_pin9_config = (/* Pin is configured as SCT0_TRIG0 */
                                        IOPCTL_PIO_FUNC2 |
                                        /* Disable pull-up / pull-down function */
                                        IOPCTL_PIO_PUPD_DI |
                                        /* Enable pull-down function */
                                        ...
                                        /* Selects transmitter current drive 100ohm */
                                        IOPCTL_PIO_DRIVE_100OHM);
    /* PORT1 PIN9 (coords: T5) is configured as SCT0_TRIG0 */
    IOPCTL_PinMuxSet(1U, 9U, port1_pin9_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
