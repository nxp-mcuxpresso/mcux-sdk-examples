...
- pin_list:
  ...
  - {pin_num: H2, peripheral: CCM, signal: CLKO1, pin_signal: GPIO_SD_B0_04, hysteresis_enable: Disable}
  - {pin_num: J2, peripheral: CCM, signal: CLKO2, pin_signal: GPIO_SD_B0_05, hysteresis_enable: Disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
