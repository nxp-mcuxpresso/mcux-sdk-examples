...
typedef enum __host_audio_app_runState
{
    ...
    kUSB_HostAudioRunWaitSetOutStreamInterface,  /*!< wait steam interface done */
    kUSB_HostAudioRunSetOutStreamInterfaceDone,        /*!< set interface done */
    kUSB_HostAudioRunWaitSetControlInterfaceRec,
    kUSB_HostAudioRunSetControlInterfaceRecDone,
    kUSB_HostAudioRunWaitSetInStreamInterface,  /*!< wait steam interface done */
    kUSB_HostAudioRunSetInStreamInterfaceDone,  /*!< steam interface done */
    ...
    kUSB_HostAudioRunWaitAudioSpeakerSetCurSamplingFreq, /*!< wait config audio set sampling freq*/
    kUSB_HostAudioRunWaitAudioRecorderSetCurSamplingFreq, /*!< wait config audio set sampling freq*/
    kUSB_HostAudioRunAudioSpeakerSetCurSamplingFreq,     /*!< execute audio set current sampling freq*/
    kUSB_HostAudioRunAudioRecorderSetCurSamplingFreq,     /*!< execute audio set current sampling freq*/
    ...
    kUSB_HostAudioRunAudioSpeakerGetSampleFrequencyRange,        /*!< get sample frequency range */
    kUSB_HostAudioRunAudioRecorderGetSampleFrequencyRange,        /*!< get sample frequency range */
    kUSB_HostAudioRunWaitAudioSpeakerGetSampleFrequencyRange,    /*!< wait get sample frequency range */
    kUSB_HostAudioRunWaitAudioRecorderGetSampleFrequencyRange,
    kUSB_HostAudioRunAudioSpeakerGetAllSampleFrequencyRange,     /*!< get all sample frequency range */
    kUSB_HostAudioRunAudioRecorderGetAllSampleFrequencyRange,     /*!< get all sample frequency range */
    kUSB_HostAudioRunWaitAudioSpeakerGetAllSampleFrequencyRange, /*!< wait get all sample frequency range */
    kUSB_HostAudioRunWaitAudioRecorderGetAllSampleFrequencyRange, /*!< wait get all sample frequency range */
...
typedef struct _audio_speraker_instance
{
    ...
    usb_host_class_handle speakerClassHandle;    /*!< the audio speaker class handle */
    usb_host_class_handle recorderClassHandle;   /*!< the audio recorder class handle */
    usb_host_interface_handle controlIntfHandle; /*!< the audio speaker control interface handle */
    usb_host_interface_handle outStreamIntfHandle;  /*!< the audio out stream interface handle */
    usb_host_interface_handle inStreamIntfHandle;  /*!< the audio in stream interface handle */
    ...
    uint8_t format_change;
    uint32_t audioRecorderIsoMaxPacketSize;
} audio_unified_instance_t;
