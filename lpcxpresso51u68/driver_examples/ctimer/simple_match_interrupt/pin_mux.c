...
void BOARD_InitPins(void) { /* Function assigned for the Cortex-M0P */
  ...
  IOCON_PinMuxSet(IOCON, 0U, 29U, port0_pin29_config);       /* PORT0 PIN29 (number: 11) is configured as CTIMER0_MAT3 */
  ...
  IOCON_PinMuxSet(IOCON, 0U, 5U, port0_pin5_config);         /* PORT0 PIN5 (number: 39) is configured as CTIMER0_MAT0 */
}
