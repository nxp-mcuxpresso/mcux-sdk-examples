...
- pin_list:
  ...
  - {pin_num: '13', peripheral: GPIO, signal: 'PIO0, 31', pin_signal: PIO0_31/FC2_CTS_SDA_SSEL0/CTIMER0_CAP3/CTIMER0_MAT3/ADC0_2, mode: pullUp, invert: disabled,
...
void BOARD_InitPins(void) { /* Function assigned for the Cortex-M0P */
  ...
  IOCON_PinMuxSet(IOCON, 0U, 24U, port0_pin24_config);       /* PORT0 PIN24 (number: 2) is configured as PIO0_24 */
  ...
  IOCON_PinMuxSet(IOCON, 0U, 31U, port0_pin31_config);       /* PORT0 PIN31 (number: 13) is configured as PIO0_31 */
  ...
  IOCON_PinMuxSet(IOCON, 0U, 4U, port0_pin4_config);         /* PORT0 PIN4 (number: 38) is configured as PIO0_4 */
  ...
  IOCON_PinMuxSet(IOCON, 1U, 10U, port1_pin10_config);       /* PORT1 PIN10 (number: 30) is configured as PIO1_10 */
  ...
  IOCON_PinMuxSet(IOCON, 1U, 9U, port1_pin9_config);         /* PORT1 PIN9 (number: 29) is configured as PIO1_9 */
}
