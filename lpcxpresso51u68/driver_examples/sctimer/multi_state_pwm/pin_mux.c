...
void BOARD_InitPins(void) { /* Function assigned for the Cortex-M0P */
  ...
  IOCON_PinMuxSet(IOCON, 0U, 29U, port0_pin29_config);       /* PORT0 PIN29 (number: 11) is configured as SCT0_OUT2 */
  ...
  IOCON_PinMuxSet(IOCON, 1U, 10U, port1_pin10_config);       /* PORT1 PIN10 (number: 30) is configured as SCT0_OUT4 */
}
