...
- pin_list:
  ...
  - {pin_num: '19', peripheral: ACMP, signal: ACMP_IN1, pin_signal: PIO0_0, mode: inactive, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t pio17_config = (/* No addition pin function */
