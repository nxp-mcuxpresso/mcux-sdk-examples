...
- pin_list:
  ...
  - {pin_num: '36', peripheral: LPI2C0, signal: SDA, pin_signal: PTA2/LPI2C0_SDA/EWM_OUT_b/LPUART0_RX, identifier: ''}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
- options: {callFromInitBoot: 'false', prefix: BOARD_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '35', peripheral: n/a, signal: disabled, pin_signal: PTA3/LPI2C0_SCL/EWM_IN/LPUART0_TX, identifier: ''}
  - {pin_num: '36', peripheral: n/a, signal: disabled, pin_signal: PTA2/LPI2C0_SDA/EWM_OUT_b/LPUART0_RX, identifier: ''}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
