...
- pin_list:
  ...
  - {pin_num: '38', peripheral: ADC0, signal: 'SE, 0', pin_signal: ADC0_SE0/ACMP0_IN0/TSI0_CH17/PTA0/LPI2C0_SCLS/LPUART0_CTS/TRGMUX_OUT3}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PORTA0 (pin 38) is configured as ADC0_SE0 */
