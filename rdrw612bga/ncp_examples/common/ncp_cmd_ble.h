...
#define NCP_BRIDGE_CMD_BLE_INVALID_CMD         (NCP_BRIDGE_CMD_BLE | NCP_BRIDGE_CMD_BLE_CORE | 0x0000000a) /* invalid command recieve */
...
#define NCP_BRIDGE_EVENT_GATT_SUBSCRIPTIONED        (NCP_BRIDGE_CMD_BLE | NCP_BRIDGE_CMD_BLE_EVENT | GATT_EV_SUBSCRIPTIONED | 0x200) /* GATT Client Subscription status event */
