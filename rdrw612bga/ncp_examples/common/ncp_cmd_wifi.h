...
#define NCP_BRIDGE_CMD_WLAN_POWERMGMT_MCU_SLEEP_CFM \
    (NCP_BRIDGE_CMD_WLAN | NCP_BRIDGE_CMD_WLAN_POWERMGMT | 0x0000000c) /* MCU sleep confirm */
...
} NCP_TLV_PACK_START NCP_EVT_CSI_DATA;
