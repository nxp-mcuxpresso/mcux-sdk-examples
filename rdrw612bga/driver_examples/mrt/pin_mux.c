...
- pin_list:
  ...
  - {pin_num: C12, peripheral: GPIO, signal: 'PIO0, 1', pin_signal: GPIO_1, direction: OUTPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* Initialize GPIO functionality on pin PIO0_1 (pin C12)  */
    GPIO_PinInit(GPIO, 0U, 1U, &gpio0_pinC12_config);
