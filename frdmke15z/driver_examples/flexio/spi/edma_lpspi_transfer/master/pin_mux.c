...
- pin_list:
  ...
  - {pin_num: '2', peripheral: FLEXIO, signal: 'D, 2', pin_signal: PTE15/FXIO_D2/TRGMUX_OUT6}
  - {pin_num: '1', peripheral: FLEXIO, signal: 'D, 3', pin_signal: PTE16/FXIO_D3/TRGMUX_OUT7}
  - {pin_num: '92', peripheral: FLEXIO, signal: 'D, 0', pin_signal: PTA10/LPUART0_TX/FXIO_D0}
  - {pin_num: '91', peripheral: FLEXIO, signal: 'D, 1', pin_signal: PTA11/LPUART0_RX/FXIO_D1}
