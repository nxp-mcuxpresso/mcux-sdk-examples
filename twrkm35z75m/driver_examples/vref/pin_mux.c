...
- pin_list:
  - {pin_num: '53', peripheral: VREF, signal: VREF, pin_signal: VREF}
...
void BOARD_InitPins(void)
{
    ...
    SIM->MISC_CTL = ((SIM->MISC_CTL &
                      ...
                      (~(SIM_MISC_CTL_UART2IRSEL_MASK | SIM_MISC_CTL_VREFBUFOUTEN_MASK)))
                     ...
                     /* VrefBuffer Output Enable: Buffer drives selected voltage (selected by vref_buffer_sel) on
                      * pad. */
                     | SIM_MISC_CTL_VREFBUFOUTEN(MISC_CTL_VREFBUFOUTEN_0b1));
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
