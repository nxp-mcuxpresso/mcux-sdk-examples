...
void SPI0_DeinitPins(void)
{
    ...
    /* PORTG2 (pin 112) is configured as ADC0_SE11 */
    PORT_SetPinMux(PORTG, 2U, kPORT_PinDisabledOrAnalog);

    /* PORTG3 (pin 113) is configured as LCD_P10 */
    PORT_SetPinMux(PORTG, 3U, kPORT_PinDisabledOrAnalog);

    /* PORTG4 (pin 114) is configured as LCD_P11 */
    PORT_SetPinMux(PORTG, 4U, kPORT_PinDisabledOrAnalog);

    /* PORTG5 (pin 115) is configured as LCD_P12 */
