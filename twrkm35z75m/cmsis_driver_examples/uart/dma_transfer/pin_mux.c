...
void UART0_DeinitPins(void)
{
    ...
    /* PORTK2 (pin 81) is configured as ADC0_SE14 */
    PORT_SetPinMux(PORTK, 2U, kPORT_PinDisabledOrAnalog);

    /* PORTK3 (pin 82) is configured as ADC0_SE15 */
    PORT_SetPinMux(PORTK, 3U, kPORT_PinDisabledOrAnalog);
}
...
void UART1_DeinitPins(void)
{
    ...
    /* PORTK5 (pin 98) is disabled */
    PORT_SetPinMux(PORTK, 5U, kPORT_PinDisabledOrAnalog);

    /* PORTK6 (pin 99) is disabled */
    PORT_SetPinMux(PORTK, 6U, kPORT_PinDisabledOrAnalog);
}
...
void UART2_DeinitPins(void)
{
    ...
    PORT_SetPinMux(PORTI, 6U, kPORT_PinDisabledOrAnalog);

    /* PORTI7 (pin 7) is configured as LCD_P47 */
    PORT_SetPinMux(PORTI, 7U, kPORT_PinDisabledOrAnalog);
}
...
void UART3_InitPins(void)
{
    ...
    /* PORTC2 (pin 29) is configured as UART3_TX */
    PORT_SetPinMux(PORTC, 2U, kPORT_MuxAlt2);

    /* PORTC3 (pin 30) is configured as UART3_RX */
    ...
    SIM->MISC_CTL = ((SIM->MISC_CTL &
                     ...
                     /* UART3 IrDA Select: Pad RX input (PTC[3] or PTD[7], as selected in Pinmux control)
                      * selected for RX input of UART3 and UART3 TX signal is not used for modulation. */
                     | SIM_MISC_CTL_UART3IRSEL(MISC_CTL_UART3IRSEL_0b0));
}
...
void UART3_DeinitPins(void)
{
    ...
    /* PORTC2 (pin 29) is configured as LCD_P41 */
    PORT_SetPinMux(PORTC, 2U, kPORT_PinDisabledOrAnalog);

    /* PORTC3 (pin 30) is configured as CMP0_IN3 */
