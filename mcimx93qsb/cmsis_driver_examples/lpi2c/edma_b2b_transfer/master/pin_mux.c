...
- pin_list:
  - {pin_num: A12, peripheral: GPIO1, signal: 'gpio_io, 00', pin_signal: I2C1_SCL, SION: ENABLED}
  - {pin_num: B12, peripheral: GPIO1, signal: 'gpio_io, 01', pin_signal: I2C1_SDA, SION: ENABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
