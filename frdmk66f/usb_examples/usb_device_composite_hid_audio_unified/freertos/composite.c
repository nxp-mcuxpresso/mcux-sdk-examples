...
#endif
{
    ...
    audioTxConfig.srcClock_Hz                    = DEMO_AUDIO_SAI_MASTER_CLOCK;
    ...
    audioRxConfig.srcClock_Hz                    = DEMO_AUDIO_SAI_MASTER_CLOCK;
    ...
    audioRxConfig.fifoWatermark                  = (uint8_t)((uint32_t)FSL_FEATURE_SAI_FIFO_COUNTn(BOARD_DEMO_SAI) / 2U);
