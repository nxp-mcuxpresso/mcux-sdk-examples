...
- pin_list:
  ...
  - {pin_num: A2, peripheral: FLEXCOMM0, signal: TXD_SCL_MISO, pin_signal: PIO0_30/FC0_TXD_SCL_MISO/CTIMER0_MAT0/SCT0_OUT9/TRACEDATA(1), mode: inactive, invert: disabled,
    glitch_filter: disabled, slew_rate: standard, open_drain: disabled}
  - {pin_num: K12, peripheral: GPIO, signal: 'PIO1, 1', pin_signal: PIO1_1/FC3_RXD_SDA_MOSI/CTIMER0_CAP3/SCT0_GPI5/USB1_OVERCURRENTN, direction: INPUT, mode: pullUp,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t SW5 = (/* Pin is configured as PIO1_1 */
                          IOCON_PIO_FUNC0 |
    ...
    IOCON_PinMuxSet(IOCON, BOARD_SW5_PORT, BOARD_SW5_PIN, SW5);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
