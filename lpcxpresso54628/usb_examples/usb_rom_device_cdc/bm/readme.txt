LPCXpresso54628 USB Virtual Comm port Example
======================================
...
a new serial port. Using a serial terminal communication between the host and LPCXpresso54628 can be established.
