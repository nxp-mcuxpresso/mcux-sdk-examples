...
- pin_list:
  ...
  - {pin_num: '74', peripheral: CCM, signal: CLKO1, pin_signal: GPIO_SD_02, slew_rate: Slow, software_input_on: Disable, open_drain: Disable, speed: MHZ_100, drive_strength: R0_4,
    pull_keeper_select: Keeper, pull_keeper_enable: Enable, pull_up_down_config: Pull_Down_100K_Ohm, hysteresis_enable: Disable}
  - {pin_num: '75', peripheral: CCM, signal: CLKO2, pin_signal: GPIO_SD_01, slew_rate: Slow, software_input_on: Disable, open_drain: Disable, speed: MHZ_100, drive_strength: R0_4,
    pull_keeper_select: Keeper, pull_keeper_enable: Enable, pull_up_down_config: Pull_Down_100K_Ohm, hysteresis_enable: Disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_SD_01_CCM_CLKO2, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_SD_02_CCM_CLKO1, 0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_09_LPUART1_RXD, 0x10A0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_10_LPUART1_TXD, 0x10A0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_SD_01_CCM_CLKO2, 0x10A0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_SD_02_CCM_CLKO1, 0x10A0U); 
}
