...
- pin_list:
  ...
  - {pin_num: '70', peripheral: GPIO2, signal: 'gpio_io, 05', pin_signal: GPIO_SD_05, software_input_on: Disable, open_drain: Disable, drive_strength: R0_4, pull_keeper_select: Pull,
