...
#define BOARD_RXD_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define BOARD_RXD_PIN 16U                   /*!<@brief PORT pin number */
#define BOARD_RXD_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                            /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_TXD_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define BOARD_TXD_PIN 17U                   /*!<@brief PORT pin number */
#define BOARD_TXD_PIN_MASK (1U << 17U)      /*!<@brief PORT pin mask */
                                            /* @} */
