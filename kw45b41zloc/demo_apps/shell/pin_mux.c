...
- {pin_num: '37', pin_signal: PTC0/WUU0_P7/LPSPI1_PCS2/CAN0_TX/I3C0_SDA/TPM1_CH0/LPI2C1_SCL/FLEXIO0_D16, label: LED1_R1, identifier: LED1_R;LED1_R1}
- {pin_num: '44', pin_signal: ADC0_A8/PTC6/WUU0_P11/LPSPI1_PCS1/TPM1_CH5/FLEXIO0_D22, label: LED2_Y2, identifier: LED2_YEL;LED2_Y2}
...
- pin_list:
  ...
  - {pin_num: '37', peripheral: GPIOC, signal: 'GPIO, 0', pin_signal: PTC0/WUU0_P7/LPSPI1_PCS2/CAN0_TX/I3C0_SDA/TPM1_CH0/LPI2C1_SCL/FLEXIO0_D16, identifier: LED1_R1,
    direction: OUTPUT, pull_select: down, pull_enable: disable, pull_value: low, slew_rate: fast, passive_filter: disable, open_drain: disable, drive_strength: low,
    drive_strength_1: normal}
  - {pin_num: '44', peripheral: GPIOC, signal: 'GPIO, 6', pin_signal: ADC0_A8/PTC6/WUU0_P11/LPSPI1_PCS1/TPM1_CH5/FLEXIO0_D22, identifier: LED2_Y2, direction: OUTPUT,
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITPINS_LED2_Y2_GPIO, BOARD_INITPINS_LED2_Y2_PIN, &LED2_Y2_config);
    ...
    PORT_SetPinConfig(BOARD_INITPINS_LED2_Y2_PORT, BOARD_INITPINS_LED2_Y2_PIN, &LED2_Y2);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
