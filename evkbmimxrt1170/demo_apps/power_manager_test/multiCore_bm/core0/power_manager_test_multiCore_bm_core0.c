...
{                                                           \
    "Setpoint0, CM7 domain WAIT, CM4 domain WAIT",          \
    "Setpoint1, CM7 domain STOP, CM4 domain WAIT",          \
...
#define APP_SETPOINT1_CONSTRAINTS                       \
    3U, PM_RESC_CORE_DOMAIN_STOP, PM_RESC_SYS_PLL1_ON, PM_RESC_LPSR_DIG_LDO_OFF
...
/*!
 * @brief Callback function for g_notify1 to de-init uart before entering low power state and re-init uart after exiting.
 */
status_t APP_UartControlCallback(pm_event_type_t eventType, uint8_t powerState, void *data)
{
