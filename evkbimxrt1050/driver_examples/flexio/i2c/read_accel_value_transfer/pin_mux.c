...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_B0_06_FLEXIO2_D06, 1U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_12_LPUART1_TXD, 0x10B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_13_LPUART1_RXD, 0x10B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_05_FLEXIO2_D05, 0xF8B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_06_FLEXIO2_D06, 0xF8B0U); 
}
