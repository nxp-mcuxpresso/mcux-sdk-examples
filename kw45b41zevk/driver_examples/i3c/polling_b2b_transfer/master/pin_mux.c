...
- pin_list:
  - {pin_num: '38', peripheral: I3C, signal: SCL, pin_signal: PTC1/WUU0_P8/LPSPI1_PCS3/CAN0_RX/I3C0_SCL/TPM1_CH1/LPI2C1_SDA/FLEXIO0_D17, pull_select: up, pull_enable: enable,
    slew_rate: fast, passive_filter: disable, open_drain: disable, drive_strength: low, drive_strength_1: normal}
  - {pin_num: '37', peripheral: I3C, signal: SDA, pin_signal: PTC0/WUU0_P7/LPSPI1_PCS2/CAN0_TX/I3C0_SDA/TPM1_CH0/LPI2C1_SCL/FLEXIO0_D16, pull_select: up, pull_enable: enable,
...
void BOARD_InitPins(void)
{
    ...
    /* PORTC0 (pin 37) is configured as I3C0_SDA */
    ...
    const port_pin_config_t portc1_pin38_config = {/* Internal pull-up resistor is enabled */
                                                   ...
                                                   /* Pin Control Register fields [15:0] are not locked */
                                                   (uint16_t)kPORT_UnlockRegister};
    /* PORTC1 (pin 38) is configured as I3C0_SCL */
