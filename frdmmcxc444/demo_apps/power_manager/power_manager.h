...
typedef enum _app_power_mode
{
    ...
    kAPP_PowerModeVlpw,  /*!< Very low power wait mode. */
    kAPP_PowerModeVlps,  /*!< Very low power stop mode. */
    kAPP_PowerModeLls,   /*!< Low leakage stop mode. */
    kAPP_PowerModeVlls0, /*!< Very low leakage stop 0 mode. */
    kAPP_PowerModeVlls1, /*!< Very low leakage stop 1 mode. */
    kAPP_PowerModeVlls3, /*!< Very low leakage stop 3 mode. */
    kAPP_PowerModeMax
} app_power_mode_t;
 ...
 *  mode - MCXC power mode. List of available modes is chip-specific. See power_manager_modes_t
 *   list of modes. This item is common for all MCXC chips.
