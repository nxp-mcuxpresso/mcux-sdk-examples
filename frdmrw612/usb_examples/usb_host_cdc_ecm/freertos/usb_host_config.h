...
/**
 * @brief host CDC RNDIS class instance count, meantime it indicates CDC RNDIS class enable or disable.
 *        - if 0, host CDC RNDIS class driver is disable.
 *        - if greater than 0, host CDC RNDIS class driver is enable.
 */
