...
3. When the demo starts, a welcome message would appear on the terminal, press enter for command prompt:
   Press tab or type help to list out all available CLI commands.
    ...
    #wps - pbc
    When AP starts WPS-PBC, use "wlan-start-wps-pbc" to start this connection.
    #wps - pin
    Use the cmd “wlan-generate-wps-pin” to generate 8 digit pin code,
	then AP starts WPS-PIN with the specific pin code and use cmd "wlan-start-wps-pin <8 digit pin>" to start this connection.
