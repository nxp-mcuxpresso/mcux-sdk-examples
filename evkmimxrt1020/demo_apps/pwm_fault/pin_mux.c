...
- pin_list:
  - {pin_num: '101', peripheral: LPUART1, signal: RX, pin_signal: GPIO_AD_B0_07, open_drain: Disable, hysteresis_enable: Disable}
  - {pin_num: '105', peripheral: LPUART1, signal: TX, pin_signal: GPIO_AD_B0_06, open_drain: Disable, hysteresis_enable: Disable}
  - {pin_num: '94', peripheral: CMP1, signal: 'IN, 0', pin_signal: GPIO_AD_B0_14, open_drain: Disable, hysteresis_enable: Disable}
  - {pin_num: '84', peripheral: PWM1, signal: 'A, 0', pin_signal: GPIO_AD_B1_06, open_drain: Disable, hysteresis_enable: Disable}
