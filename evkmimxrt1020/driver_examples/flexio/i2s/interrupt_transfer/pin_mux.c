...
void BOARD_FLEXIO_ConfigurePins(void) {
  ...
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B1_10_FLEXIO1_FLEXIO05, 0x10B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B1_11_FLEXIO1_FLEXIO04, 0x10B0U); 
...
void BOARD_SAI_ConfigurePins(void) {
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B1_00_SAI1_MCLK, 0U); 
