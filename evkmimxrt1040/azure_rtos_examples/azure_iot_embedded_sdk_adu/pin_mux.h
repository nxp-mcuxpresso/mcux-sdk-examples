...
/* Routed pin properties */
#define BOARD_INITPINS_WIFI_EST_B_PERIPHERAL                               GPIO3   /*!< Peripheral name */
#define BOARD_INITPINS_WIFI_EST_B_SIGNAL                                 gpio_io   /*!< Signal name */
#define BOARD_INITPINS_WIFI_EST_B_CHANNEL                                     4U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_WIFI_EST_B_GPIO                                     GPIO3   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_WIFI_EST_B_GPIO_PIN                                    4U   /*!< GPIO pin number */
#define BOARD_INITPINS_WIFI_EST_B_GPIO_PIN_MASK                       (1U << 4U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_WIFI_EST_B_PORT                                     GPIO3   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_WIFI_EST_B_PIN                                         4U   /*!< PORT pin number */
#define BOARD_INITPINS_WIFI_EST_B_PIN_MASK                            (1U << 4U)   /*!< PORT pin mask */
