...
- pin_list:
  ...
  - {pin_num: B13, peripheral: ENET, signal: enet_tx_en, pin_signal: GPIO_B1_09, software_input_on: Disable, hysteresis_enable: Disable, pull_up_down_config: Pull_Up_100K_Ohm,
    pull_keeper_select: Pull, pull_keeper_enable: Enable, open_drain: Disable, speed: MHZ_200, drive_strength: R0_5, slew_rate: Fast}
  - {pin_num: N2, peripheral: GPIO3, signal: 'gpio_io, 04', pin_signal: GPIO_SD_B1_04, direction: OUTPUT, gpio_init_state: 'true', pull_up_down_config: Pull_Up_100K_Ohm,
    speed: MHZ_50, drive_strength: R0_5}
  - {pin_num: G10, peripheral: GPIO1, signal: 'gpio_io, 10', pin_signal: GPIO_AD_B0_10, direction: INPUT, software_input_on: Disable, hysteresis_enable: Disable,
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of INT1_COMBO on GPIO_AD_B0_10 (pin G10) */
  ...
  /* GPIO configuration of WIFI_EST_B on GPIO_SD_B1_04 (pin N2) */
  gpio_pin_config_t WIFI_EST_B_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_SD_B1_04 (pin N2) */
  GPIO_PinInit(GPIO3, 4U, &WIFI_EST_B_config);
