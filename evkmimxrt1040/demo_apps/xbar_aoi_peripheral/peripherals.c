 ...
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
const aoi_event_config_t DEMO_AOI1_event_config[1] = {
  {
...
static void DEMO_AOI1_init(void) {
  /* Initialize AOI1 peripheral. */
  AOI_Init(DEMO_AOI1_PERIPHERAL);
  /* Initialize AOI1 Event 0. */
  AOI_SetEventLogicConfig(DEMO_AOI1_PERIPHERAL, kAOI_Event0, &DEMO_AOI1_event_config[0]);
}
