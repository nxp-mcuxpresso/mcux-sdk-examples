...
#define GPR7_STOP_REQ_BITS                                                           \
    (IOMUXC_GPR_GPR7_LPI2C1_STOP_REQ_MASK | IOMUXC_GPR_GPR7_LPI2C2_STOP_REQ_MASK |   \
     ...
     IOMUXC_GPR_GPR7_LPSPI3_STOP_REQ_MASK | IOMUXC_GPR_GPR7_LPUART1_STOP_REQ_MASK |  \
     IOMUXC_GPR_GPR7_LPUART2_STOP_REQ_MASK | IOMUXC_GPR_GPR7_LPUART3_STOP_REQ_MASK | \
     IOMUXC_GPR_GPR7_LPUART4_STOP_REQ_MASK | IOMUXC_GPR_GPR7_LPUART5_STOP_REQ_MASK | \
     IOMUXC_GPR_GPR7_LPUART6_STOP_REQ_MASK | IOMUXC_GPR_GPR7_LPUART7_STOP_REQ_MASK | \
...
#define GPR7_STOP_ACK_BITS                                                           \
    (IOMUXC_GPR_GPR7_LPI2C1_STOP_ACK_MASK | IOMUXC_GPR_GPR7_LPI2C2_STOP_ACK_MASK |   \
     ...
     IOMUXC_GPR_GPR7_LPSPI3_STOP_ACK_MASK | IOMUXC_GPR_GPR7_LPUART1_STOP_ACK_MASK |  \
     IOMUXC_GPR_GPR7_LPUART2_STOP_ACK_MASK | IOMUXC_GPR_GPR7_LPUART3_STOP_ACK_MASK | \
     IOMUXC_GPR_GPR7_LPUART4_STOP_ACK_MASK | IOMUXC_GPR_GPR7_LPUART5_STOP_ACK_MASK | \
     IOMUXC_GPR_GPR7_LPUART6_STOP_ACK_MASK | IOMUXC_GPR_GPR7_LPUART7_STOP_ACK_MASK | \
...
#define GPR8_DOZE_BITS                                                               \
    (IOMUXC_GPR_GPR8_LPI2C1_IPG_DOZE_MASK | IOMUXC_GPR_GPR8_LPI2C2_IPG_DOZE_MASK |   \
     ...
     IOMUXC_GPR_GPR8_LPSPI3_IPG_DOZE_MASK | IOMUXC_GPR_GPR8_LPUART1_IPG_DOZE_MASK |  \
     IOMUXC_GPR_GPR8_LPUART2_IPG_DOZE_MASK | IOMUXC_GPR_GPR8_LPUART3_IPG_DOZE_MASK | \
     IOMUXC_GPR_GPR8_LPUART4_IPG_DOZE_MASK | IOMUXC_GPR_GPR8_LPUART5_IPG_DOZE_MASK | \
     IOMUXC_GPR_GPR8_LPUART6_IPG_DOZE_MASK | IOMUXC_GPR_GPR8_LPUART7_IPG_DOZE_MASK | \
...
#define GPR8_STOP_MODE_BITS                                                                    \
    (IOMUXC_GPR_GPR8_LPI2C1_IPG_STOP_MODE_MASK | IOMUXC_GPR_GPR8_LPI2C2_IPG_STOP_MODE_MASK |   \
     ...
     IOMUXC_GPR_GPR8_LPSPI3_IPG_STOP_MODE_MASK | IOMUXC_GPR_GPR8_LPUART2_IPG_STOP_MODE_MASK |  \
     IOMUXC_GPR_GPR8_LPUART3_IPG_STOP_MODE_MASK | IOMUXC_GPR_GPR8_LPUART4_IPG_STOP_MODE_MASK | \
     IOMUXC_GPR_GPR8_LPUART5_IPG_STOP_MODE_MASK | IOMUXC_GPR_GPR8_LPUART6_IPG_STOP_MODE_MASK | \
     IOMUXC_GPR_GPR8_LPUART7_IPG_STOP_MODE_MASK | IOMUXC_GPR_GPR8_LPUART8_IPG_STOP_MODE_MASK)
