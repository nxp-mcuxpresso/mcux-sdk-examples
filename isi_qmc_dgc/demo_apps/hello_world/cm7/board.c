...
void BOARD_ConfigMPU(void)
{
    ...
    /* Region 3 setting: Memory with Normal type, non-shareable, outer/inner write back - consider OCRAM LMEM -> CM4
     * TCMs */
    ...
    /* Region 8 setting: Memory with Normal type, non-shareable, non-cacheable, - consider OCRAM ECC1 - RPC msg
     * (required by MAD team */
