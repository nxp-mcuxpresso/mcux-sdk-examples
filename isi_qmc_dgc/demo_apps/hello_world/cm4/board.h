...
#define DEBUG_CONSOLE_UART_INDEX \
    6 /* EVK or EVB, if ISI_QMC used this must not be used, We expect LPUART6 to be used with DEBUG CONSOLE */
#endif
...
#define FMSTR_UART_INDEX \
    6 /* EVK or EVB, if ISI_QMC used this must not be used, We expect LPUART8 to be used with FMSTR */
#endif
...
#define DIG_OUT_0_OFF() GPIO_PortClear(BOARD_DIG_OUT_0_GPIO, 1U << BOARD_DIG_OUT_0_GPIO_PIN)
...
#define DIG_OUT_1_OFF() GPIO_PortClear(BOARD_DIG_OUT_1_GPIO, 1U << BOARD_DIG_OUT_1_GPIO_PIN)
...
#define DIG_OUT_2_OFF() GPIO_PortClear(BOARD_DIG_OUT_2_GPIO, 1U << BOARD_DIG_OUT_2_GPIO_PIN)
...
#define DIG_OUT_3_OFF() GPIO_PortClear(BOARD_DIG_OUT_3_GPIO, 1U << BOARD_DIG_OUT_3_GPIO_PIN)
...
#define SLOW_DIG_OUT_4_OFF() GPIO_PortClear(BOARD_SLOW_DIG_OUT_4_GPIO, 1U << BOARD_SLOW_DIG_OUT_4_GPIO_PIN)
...
#define SLOW_DIG_OUT_5_OFF() GPIO_PortClear(BOARD_SLOW_DIG_OUT_5_GPIO, 1U << BOARD_SLOW_DIG_OUT_5_GPIO_PIN)
...
#define SLOW_DIG_OUT_6_OFF() GPIO_PortClear(BOARD_SLOW_DIG_OUT_6_GPIO, 1U << BOARD_SLOW_DIG_OUT_6_GPIO_PIN)
...
#define SLOW_DIG_OUT_7_OFF() GPIO_PortClear(BOARD_SLOW_DIG_OUT_7_GPIO, 1U << BOARD_SLOW_DIG_OUT_7_GPIO_PIN)
...
#define SE050_RST_RELEASE() \
    GPIO_PortSet(BOARD_USER_LED_GPIO, 1U << BOARD_USER_LED_GPIO_PIN) /*!<Turn on target SE050_RST*/
...
#define SPI_DEVICE_SEL0_LOW()  GPIO_PortClear(BOARD_SPI_DEVICE_SEL0_GPIO, 1U << BOARD_SPI_DEVICE_SEL0_PIN)
...
#define SPI_DEVICE_SEL1_LOW()  GPIO_PortClear(BOARD_SPI_DEVICE_SEL1_GPIO, 1U << BOARD_SPI_DEVICE_SEL1_PIN)
