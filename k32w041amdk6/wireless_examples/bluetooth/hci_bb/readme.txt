Overview
========
This application implements a Bluetooth Low Energy HCI Black Box which can communicate over a serial interface.
...
4.  Open Test Tool 12 and use the following settings with the the detected serial device:
    - 115200 baud rate
    - 8 data bits
    - No parity
    - One stop bit
