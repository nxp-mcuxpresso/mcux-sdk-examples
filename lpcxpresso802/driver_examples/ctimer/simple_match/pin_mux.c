...
- pin_list:
  ...
  - {pin_num: '13', peripheral: CTIMER0, signal: 'MATCH, 3', pin_signal: PIO0_9/ADC_4}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* TimerMatchChannel3 connect to P0_9 */
    SWM_SetMovablePinSelect(SWM0, kSWM_T0_MAT_CHN3, kSWM_PortPin_P0_9);
