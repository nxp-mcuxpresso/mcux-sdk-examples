...
## Board Settings
------------------------
CN3 pin 20 is ACOMP negative input pin, which can sample external voltage.
...
## Expected Result
------------------------
If the ACOMP input pin(CN3 pin 20) connects the GND, LED(LD19&&LD20) will be turned on.
