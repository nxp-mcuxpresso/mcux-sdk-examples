...
- pin_list:
  ...
  - {pin_num: '51', peripheral: FTM2, signal: 'CH, 4', pin_signal: PTG6/KBI1_P22/FTM2_CH4/SPI1_MISO}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* pin 51 is configured as FTM2_CH4 */
    PORT_SetPinSelect(kPORT_FTM2CH4, kPORT_FTM2_CH4_PTG6);
