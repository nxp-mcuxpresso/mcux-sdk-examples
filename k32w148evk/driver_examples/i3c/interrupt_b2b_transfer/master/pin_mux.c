...
- pin_list:
  - {pin_num: '38', peripheral: I3C, signal: SCL, pin_signal: PTC1/WUU0_P8/LPSPI1_PCS3/I3C0_SCL/TPM1_CH1/LPI2C1_SDA/FLEXIO0_D17, pull_select: up, pull_enable: enable,
    slew_rate: fast, passive_filter: disable, open_drain: disable, drive_strength: low, drive_strength_1: normal}
  - {pin_num: '37', peripheral: I3C, signal: SDA, pin_signal: PTC0/WUU0_P7/LPSPI1_PCS2/I3C0_SDA/TPM1_CH0/LPI2C1_SCL/FLEXIO0_D16, pull_select: up, pull_enable: enable,
