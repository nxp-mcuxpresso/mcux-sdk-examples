...
DECL_STATIC void le_audio_pl_start_audio_rx(void)
{
    ...
    audio_frame_length = ( (leaudio_snk_sf / 100U) * appl_ga_utils_audio_snk_get_fd() * (leaudio_snk_bps / 8U) * leaudio_snk_nc ) / 100U;
...
DECL_STATIC void le_audio_pl_start_tx(void)
{
	...
	le_audio_src_pl_data.le_audio_src_frame_len = ( (leaudio_src_sf / 100U) * appl_ga_utils_audio_src_get_fd() * (leaudio_src_bps / 8U) * leaudio_src_nc ) / 100U;
