...
- pin_list:
  - {pin_num: '101', peripheral: LPUART1, signal: RX, pin_signal: GPIO_AD_B0_07, software_input_on: Disable, open_drain: Disable, hysteresis_enable: Disable}
  ...
  - {pin_num: '80', peripheral: GPT2, signal: 'gpt_capture, 1', pin_signal: GPIO_AD_B1_10, software_input_on: Disable, open_drain: Disable, hysteresis_enable: Disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B1_10_GPT2_CAPTURE1,     /* GPIO_AD_B1_10 is configured as GPT2_CAPTURE1 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinConfig(
  ...
  IOMUXC_SetPinConfig(
      ...
      0x10B0U);                               /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Disabled */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_B1_10_GPT2_CAPTURE1,     /* GPIO_AD_B1_10 PAD functional properties : */
      0x10B0U);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: 100MHz - 150MHz
                                                 Open Drain Enable Field: Open Drain Disabled
