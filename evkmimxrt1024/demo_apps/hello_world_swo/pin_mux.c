...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B0_11_ARM_TRACE_SWO,     /* GPIO_AD_B0_11 is configured as ARM_TRACE_SWO */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
#else
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B0_11_ARM_CM7_TRACE_SWO,  /* GPIO_AD_B0_11 is configured as ARM_TRACE_SWO */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
#endif
  IOMUXC_SetPinMux(
...
#if FSL_IOMUXC_DRIVER_VERSION >= MAKE_VERSION(2, 0, 3)
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_B0_11_ARM_TRACE_SWO,     /* GPIO_AD_B0_11 PAD functional properties : */
