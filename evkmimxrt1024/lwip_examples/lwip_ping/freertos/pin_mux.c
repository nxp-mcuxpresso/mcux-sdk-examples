...
pin_labels:
- {pin_num: '84', pin_signal: GPIO_AD_B1_06, label: 'ENET_INT/U11[21]/J17[16]', identifier: PHY_INTR}
...
- pin_list:
  ...
  - {pin_num: '95', peripheral: ENET, signal: enet_tx_en, pin_signal: GPIO_AD_B0_13, slew_rate: Fast, speed: MHZ_200, drive_strength: R0_5, pull_keeper_select: Pull,
    pull_up_down_config: Pull_Up_100K_Ohm}
  - {pin_num: '100', peripheral: ENET, signal: enet_ref_clk, pin_signal: GPIO_AD_B0_08, direction: INPUT, slew_rate: Fast, software_input_on: Enable, speed: MHZ_200,
  ...
  - {pin_num: '115', peripheral: ENET, signal: enet_mdc, pin_signal: GPIO_EMC_41, slew_rate: Fast, speed: MHZ_200, drive_strength: R0_5, pull_keeper_select: Pull,
    pull_up_down_config: Pull_Up_100K_Ohm}
  - {pin_num: '107', peripheral: GPIO1, signal: 'gpio_io, 04', pin_signal: GPIO_AD_B0_04, drive_strength: R0_5, pull_keeper_select: Pull}
  - {pin_num: '84', peripheral: GPIO1, signal: 'gpio_io, 22', pin_signal: GPIO_AD_B1_06, direction: INPUT, gpio_interrupt: kGPIO_IntRisingEdge, slew_rate: Fast, software_input_on: Enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
