...
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_keyboard2mouse/<rtos>/readme.pdf.
For lite version, the files path is:
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_keyboard2mouse_lite/<rtos>/readme.pdf.
Note
