...
- pin_list:
  ...
  - {pin_num: '64', peripheral: CTIMER2, signal: 'MATCH, 1', pin_signal: PIO1_4/FC0_SCK/CTIMER2_MAT1/SCT0_OUT0/FREQME_GPIO_CLK_A, mode: inactive, slew_rate: standard,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port1_pin4_config = (/* Pin is configured as CTIMER2_MAT1 */
                                        ...
                                        /* Open drain is disabled */
                                        IOCON_PIO_OPENDRAIN_DI);
    /* PORT1 PIN4 (coords: 64) is configured as CTIMER2_MAT1 */
