...
- pin_list:
  ...
  - {pin_num: '58', peripheral: SECGPIO, signal: 'SECPIO0, 5', pin_signal: PIO0_5/CAN0_TD/FC4_RXD_SDA_MOSI_DATA/CTIMER3_MAT0/SCT_GPI5/FC3_RTS_SCL_SSEL1/MCLK/SECURE_GPIO0_5,
    mode: inactive, slew_rate: standard, invert: disabled, open_drain: disabled}
  - {pin_num: '44', peripheral: GPIO, signal: 'PIO0, 28', pin_signal: PIO0_28/FC0_SCK/CT_INP11/SCT0_OUT7/PLU_OUT1/SECURE_GPIO0_28, mode: inactive, slew_rate: standard,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin5_config = (/* Pin is configured as SECURE_GPIO0_5 */
                                        ...
                                        /* Open drain is disabled */
                                        IOCON_PIO_OPENDRAIN_DI);
    /* PORT0 PIN5 (coords: 58) is configured as SECURE_GPIO0_5 */
