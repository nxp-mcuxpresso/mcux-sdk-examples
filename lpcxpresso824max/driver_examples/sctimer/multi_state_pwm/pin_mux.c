...
- pin_list:
  ...
  - {pin_num: '31', peripheral: USART0, signal: RXD, pin_signal: PIO0_18/ADC_8, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
  - {pin_num: '5', peripheral: SCT0, signal: 'OUT, 2', pin_signal: PIO0_28/WKTCLKIN, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t IOCON_INDEX_PIO0_12_config = (/* Selects pull-up function */
                                                 ...
                                                 /* IOCONCLKDIV0 */
                                                 IOCON_PIO_CLKDIV0);
    /* PIO0 PIN12 (coords: 2) is configured as SCT0, IN, 0. */
    ...
    const uint32_t IOCON_INDEX_PIO0_16_config = (/* Selects pull-up function */
                                                 ...
                                                 /* IOCONCLKDIV0 */
                                                 IOCON_PIO_CLKDIV0);
    /* PIO0 PIN16 (coords: 10) is configured as SCT0, OUT, 4. */
    ...
    const uint32_t IOCON_INDEX_PIO0_28_config = (/* Selects pull-up function */
                                                 ...
                                                 /* IOCONCLKDIV0 */
                                                 IOCON_PIO_CLKDIV0);
    /* PIO0 PIN28 (coords: 5) is configured as SCT0, OUT, 2. */
