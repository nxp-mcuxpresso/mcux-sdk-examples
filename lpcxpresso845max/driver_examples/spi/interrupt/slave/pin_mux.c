...
void BOARD_InitPins(void)
{
    ...
    /* SPI0_MOSI connect to P0_25 */
    SWM_SetMovablePinSelect(SWM0, kSWM_SPI0_MOSI, kSWM_PortPin_P0_25);

    /* SPI0_MISO connect to P0_24 */
    SWM_SetMovablePinSelect(SWM0, kSWM_SPI0_MISO, kSWM_PortPin_P0_24);
