...
- pin_list:
  ...
  - {pin_num: '36', peripheral: USART0, signal: RXD, pin_signal: PIO1_16, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
  - {pin_num: '10', peripheral: CTIMER0, signal: 'MATCH, 1', pin_signal: PIO0_28, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t pio1_20_config = (/* Selects pull-up function */
                                   IOCON_PIO_MODE_PULLUP |
                                   /* Enable hysteresis */
                                   IOCON_PIO_HYS_EN |
                                   /* Input not invert */
                                   ...
                                   /* IOCONCLKDIV0 */
                                   IOCON_PIO_CLKDIV0);
    /* PIO1_20 IOCON index number is 52. it is configured as */
    IOCON_PinMuxSet(IOCON, IOCON_INDEX_PIO1_20, pio1_20_config);
