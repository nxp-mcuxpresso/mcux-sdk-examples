...
- pin_list:
  ...
  - {pin_num: '36', peripheral: USART0, signal: RXD, pin_signal: PIO1_16, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
  - {pin_num: '10', peripheral: CTIMER0, signal: 'MATCH, 1', pin_signal: PIO0_28/WKTCLKIN, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled,
    smode: bypass, clkdiv: div0}
  - {pin_num: '56', peripheral: CTIMER0, signal: 'MATCH, 0', pin_signal: PIO1_20, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t IOCON_INDEX_PIO0_28_config = (/* Selects pull-up function */
                                                 ...
                                                 /* IOCONCLKDIV0 */
                                                 IOCON_PIO_CLKDIV0);
    /* PIO0 PIN28 (coords: 10) is configured as CTIMER0, MATCH, 1. */
    ...
    const uint32_t IOCON_INDEX_PIO1_20_config = (/* Selects pull-up function */
                                                 ...
                                                 /* IOCONCLKDIV0 */
                                                 IOCON_PIO_CLKDIV0);
    /* PIO1 PIN20 (coords: 56) is configured as CTIMER0, MATCH, 0. */
    ...
    /* TimerMatchChannel0 connect to P1_20 */
    SWM_SetMovablePinSelect(SWM0, kSWM_T0_MAT_CHN0, kSWM_PortPin_P1_20);
