...
#define EXAMPLE_KBI_SIGNAL_INPUT_REF_GPIO_INDEX 3
#define EXAMPLE_KBI_SIGNAL_INPUT_GPIO           kGPIO_PORTA
#define EXAMPLE_KBI_SIGNAL_INPUT_GPIO_INDEX     2
#define EXAMPLE_KBI_PINS                        (2)
/*******************************************************************************
 * Prototypes
 ******************************************************************************/
/*******************************************************************************
