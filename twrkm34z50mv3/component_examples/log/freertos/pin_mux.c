...
- pin_list:
  ...
  - {pin_num: '64', peripheral: GPIOE, signal: 'GPIO, 5', pin_signal: PTE5/QT3/SCI2_RTS/EWM_OUT/LLWU_P6}
  - {pin_num: '47', peripheral: GPIOD, signal: 'GPIO, 0', pin_signal: CMP0P0/PTD0/SCI0_RxD/PXBAR_IN2/LLWU_P11}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
