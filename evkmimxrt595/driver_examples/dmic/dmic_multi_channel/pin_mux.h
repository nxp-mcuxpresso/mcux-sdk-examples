...
/*! @name PDM_DATA23 (coord D16), J31[6]
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_DMIC_PDM_DAT23_PERIPHERAL DMIC0      /*!<@brief Peripheral name */
#define BOARD_INITPINS_DMIC_PDM_DAT23_SIGNAL DATA           /*!<@brief Signal name */
#define BOARD_INITPINS_DMIC_PDM_DAT23_CHANNEL 23            /*!<@brief Signal channel */
                                                            /* @} */

/*! @name PDM_DATA45 (coord C16), J31[8]
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_DMIC_PDM_DAT45_PERIPHERAL DMIC0      /*!<@brief Peripheral name */
#define BOARD_INITPINS_DMIC_PDM_DAT45_SIGNAL DATA           /*!<@brief Signal name */
#define BOARD_INITPINS_DMIC_PDM_DAT45_CHANNEL 45            /*!<@brief Signal channel */
                                                            /* @} */

/*! @name PDM_DATA67 (coord D15), J31[10]
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_DMIC_PDM_DAT67_PERIPHERAL DMIC0      /*!<@brief Peripheral name */
#define BOARD_INITPINS_DMIC_PDM_DAT67_SIGNAL DATA           /*!<@brief Signal name */
#define BOARD_INITPINS_DMIC_PDM_DAT67_CHANNEL 67            /*!<@brief Signal channel */
                                                            /* @} */
