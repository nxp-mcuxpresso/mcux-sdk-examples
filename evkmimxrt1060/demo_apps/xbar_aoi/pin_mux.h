...
#define BOARD_INITPINS_ADC4_PERIPHERAL                                      CMP1   /*!< Device name: CMP1 */
#define BOARD_INITPINS_ADC4_SIGNAL                                            IN   /*!< CMP1 signal: IN */
#define BOARD_INITPINS_ADC4_CHANNEL                                           0U   /*!< CMP1 IN channel: 0 */
