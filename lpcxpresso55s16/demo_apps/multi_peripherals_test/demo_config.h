...
#define BOARD_BTN_WAKE_GPIO      BOARD_SW1_GPIO
#define BOARD_BTN_WAKE_GPIO_PORT BOARD_SW1_GPIO_PORT
#define BOARD_BTN_WAKE_GPIO_PIN  BOARD_SW1_GPIO_PIN
#define BOARD_BTN_ISP_GPIO       BOARD_SW4_GPIO
#define BOARD_BTN_ISP_GPIO_PORT  BOARD_SW4_GPIO_PORT
#define BOARD_BTN_ISP_GPIO_PIN   BOARD_SW4_GPIO_PIN
...
#define DEMO_ACC_DEVICE_ADDRESS   (0x1EU)
#define DEMO_ACC_SUB_ADDRESS      (0x0DU)
#define DEMO_ACC_SUB_ADDRESS_SIZE (1U)
#define DEMO_ACC_DEVICE_ID        (0xC7U)

#define DEMO_LED_VALUE (1U)

#define DEMO_SDCARD_NOSPORT (1U)
