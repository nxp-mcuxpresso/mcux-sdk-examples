...
- pin_list:
  ...
  - {pin_num: G15, peripheral: SCT0, signal: 'IN, 1', pin_signal: PIO1_1/FC4_SSEL2/SCT0_GPI2/SCT0_OUT8/CTIMER1_MAT0, pupdena: disabled, pupdsel: pullDown, ibena: enabled,
    slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: disabled}
  - {pin_num: P16, peripheral: SCT0, signal: 'OUT, 3', pin_signal: PIO2_30/I3C0_SDA/SCT0_OUT3/CLKIN/CMP0_OUT, pupdena: disabled, pupdsel: pullDown, ibena: disabled,
    slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: enabled}
  - {pin_num: N17, peripheral: SCT0, signal: 'OUT, 0', pin_signal: PIO2_29/I3C0_SCL/SCT0_OUT0/CLKOUT, pupdena: disabled, pupdsel: pullDown, ibena: disabled, slew_rate: normal,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port1_pin1_config = (/* Pin is configured as SCT0_GPI2 */
                                        IOPCTL_PIO_FUNC2 |
                                        /* Disable pull-up / pull-down function */
                                        IOPCTL_PIO_PUPD_DI |
                                        /* Enable pull-down function */
                                        ...
                                        /* Input function is not inverted */
                                        IOPCTL_PIO_INV_DI);
    /* PORT1 PIN1 (coords: G15) is configured as SCT0_GPI2 */
