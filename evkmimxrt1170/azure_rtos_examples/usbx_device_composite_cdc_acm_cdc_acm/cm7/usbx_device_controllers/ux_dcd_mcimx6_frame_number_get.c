...
/*  FUNCTION                                                 RELEASE      */
/*                                                                        */
/*    _ux_dcd_mcimx6_frame_number_get                       PORTABLE C    */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
ULONG       mcimx6_register;
    ...
    /* Read the frame number from the FRINDEX.  */
    mcimx6_register =  _ux_dcd_mcimx6_register_read(dcd_mcimx6, UX_DCD_MCIMX6_32BIT_REG, UX_DCD_MCIMX6_FRINDEX);

    /* We should ignore the microframe.  */
    mcimx6_register =  mcimx6_register >> UX_DCD_MCIMX6_FRINDEX_SHIFT;

    /* Return the frame number to the caller. */
    *frame_number =  mcimx6_register;
