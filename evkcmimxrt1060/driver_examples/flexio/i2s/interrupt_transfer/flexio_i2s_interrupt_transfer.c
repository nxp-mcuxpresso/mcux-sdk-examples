...
/* Select Audio PLL (180.6 MHz) as sai1 clock source */
...
/* Select Audio PLL (180.6 MHz) as flexio clock source, need to sync with sai clock, or the codec may not work */
#define DEMO_FLEXIO_CLKSRC_SEL (0U)
/* Clock pre divider for flexio clock source */
#define DEMO_FLEXIO_CLKSRC_PRE_DIV (3U)
/* Clock divider for flexio clock source */
#define DEMO_FLEXIO_CLKSRC_DIV (3U)
