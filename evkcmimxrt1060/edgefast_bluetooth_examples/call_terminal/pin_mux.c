...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: L11, peripheral: GPT2, signal: gpt_clk, pin_signal: GPIO_AD_B1_02}
  - {pin_num: C7, peripheral: GPT2, signal: 'gpt_capture, 1', pin_signal: GPIO_EMC_41, identifier: ''}
  - {pin_num: A7, peripheral: GPT2, signal: 'gpt_capture, 2', pin_signal: GPIO_EMC_40}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */

/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitGPT2Pins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_InitGPT2Pins(void) {
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B1_02_GPT2_CLK, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_40_GPT2_CAPTURE2, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_41_GPT2_CAPTURE1, 0U); 
}
