...
static void print_codec_cfg(const struct bt_audio_codec_cfg *codec_cfg)
{
	...
	if (codec_cfg->id == BT_HCI_CODING_FORMAT_LC3) {
		...
		PRINTF("  Frame Duration: %d us\n",
		       bt_audio_codec_cfg_frame_dur_to_frame_dur_us((enum bt_audio_codec_config_frame_dur)ret));
		      ...
		      struct bt_bap_ascs_rsp *rsp)
{
	...
	lc3_codec_info.frame_duration_us = bt_audio_codec_cfg_frame_dur_to_frame_dur_us((enum bt_audio_codec_config_frame_dur)bt_audio_codec_cfg_get_frame_dur(stream->codec_cfg));
